...
int main(int argc, char** argv)
{
    ...
    try {
        ...
        // The Hub provides access to one or more Myos.
        myo::Hub hub("com.ponderousmad.MyoSnap");

        std::cout << "Attempting to find a Myo..." << std::endl;

        // Next, we attempt to find a Myo to use.
        // If a Myo is already paired in Myo Connect, this will return that Myo
        // immediately.
        // waitForMyo() takes a timeout value in milliseconds.
        // In this case we will try to find a Myo for 10 seconds, and
        ...
        // Hub::addListener() takes the address of any object whose class inherits from DeviceListener,
        // and will cause Hub::run() to send events to all registered device listeners.
